...
/**
 * Created by George PC on 15/04/2018.
 */
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for(int x = 0; x < NumberofEntries; x++){
                        ...
                        activityvalues.add(new BarEntry(f,Float.parseFloat(CalculatedList[x].Active))); ;
                        f++;
                    ...
                    GraphListAdapter graphListAdapter = new GraphListAdapter(CalculatedList, NumberofEntries,0);
