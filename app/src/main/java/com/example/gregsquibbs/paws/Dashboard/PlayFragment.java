            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int x = 0; x < NumberofEntries; x++) {
                        ...
                        activityvalues.add(new BarEntry(f, Float.parseFloat(CalculatedList[x].Play)));
                        ;
                        f++;
                    ...
                    GraphListAdapter graphListAdapter = new GraphListAdapter(CalculatedList, NumberofEntries, 2);
